...
`elsif I9
    ...
    `define PAT_LEN 40
`elsif H0
    `define VDATA  "../00_TESTBED/hidden/VALID_H.dat"
    `define IDATA  "../00_TESTBED/hidden/INST_H0_I.dat"
    `define ODATA  "../00_TESTBED/hidden/INST_H0_O.dat"
    `define SEQ_LEN 250
    `define PAT_LEN 200
`elsif H1
    `define VDATA  "../00_TESTBED/hidden/VALID_H.dat"
    `define IDATA  "../00_TESTBED/hidden/INST_H1_I.dat"
    `define ODATA  "../00_TESTBED/hidden/INST_H1_O.dat"
    `define SEQ_LEN 250
    `define PAT_LEN 200
`elsif H2
    `define VDATA  "../00_TESTBED/hidden/VALID_H.dat"
    `define IDATA  "../00_TESTBED/hidden/INST_H2_I.dat"
    `define ODATA  "../00_TESTBED/hidden/INST_H2_O.dat"
    `define SEQ_LEN 250
    `define PAT_LEN 200
`elsif H3
    `define VDATA  "../00_TESTBED/hidden/VALID_H.dat"
    `define IDATA  "../00_TESTBED/hidden/INST_H3_I.dat"
    `define ODATA  "../00_TESTBED/hidden/INST_H3_O.dat"
    `define SEQ_LEN 250
    `define PAT_LEN 200
`elsif H4
    `define VDATA  "../00_TESTBED/hidden/VALID_H.dat"
    `define IDATA  "../00_TESTBED/hidden/INST_H4_I.dat"
    `define ODATA  "../00_TESTBED/hidden/INST_H4_O.dat"
    `define SEQ_LEN 250
    `define PAT_LEN 200
`else
    `define VDATA  "../00_TESTBED/pattern/VALID.dat"
